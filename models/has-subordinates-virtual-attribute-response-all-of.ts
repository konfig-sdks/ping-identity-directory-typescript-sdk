...
import { EnumhasSubordinatesVirtualAttributeSchemaUrn } from './enumhas-subordinates-virtual-attribute-schema-urn';
 ...
 * 
 * @export
 * @interface HasSubordinatesVirtualAttributeResponseAllOf
 */
export interface HasSubordinatesVirtualAttributeResponseAllOf {
    /**
     * A description for this Virtual Attribute
     * @type {string}
     * @memberof HasSubordinatesVirtualAttributeResponseAllOf
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumhasSubordinatesVirtualAttributeSchemaUrn>}
     * @memberof HasSubordinatesVirtualAttributeResponseAllOf
     */
    'schemas'?: Array<EnumhasSubordinatesVirtualAttributeSchemaUrn>;
    /**
