...
import { CryptoManagerResponseAllOf } from './crypto-manager-response-all-of';
...
/**
 * @type CryptoManagerResponse
 * @export
 */
export type CryptoManagerResponse = CryptoManagerResponseAllOf & Meta;
