...
/**
 * @type AddThirdPartyAccessLogPublisherRequest
 * @export
 */
export type AddThirdPartyAccessLogPublisherRequest = AddSyslogJsonAuditLogPublisherRequestAllOf & ThirdPartyAccessLogPublisherShared;
