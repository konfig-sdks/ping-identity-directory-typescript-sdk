...
/**
 * @type SyslogJsonAccessLogPublisherResponse
 * @export
 */
export type SyslogJsonAccessLogPublisherResponse = Meta & SyslogJsonAccessLogPublisherShared & SyslogJsonAuditLogPublisherResponseAllOf;
