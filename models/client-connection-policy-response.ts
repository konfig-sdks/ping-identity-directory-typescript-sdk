...
import { ClientConnectionPolicyResponseAllOf } from './client-connection-policy-response-all-of';
...
/**
 * @type ClientConnectionPolicyResponse
 * @export
 */
export type ClientConnectionPolicyResponse = ClientConnectionPolicyResponseAllOf & ClientConnectionPolicyShared & Meta;
