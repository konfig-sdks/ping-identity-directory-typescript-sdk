...
import { EnumcurrentTimeVirtualAttributeSchemaUrn } from './enumcurrent-time-virtual-attribute-schema-urn';
 ...
 * 
 * @export
 * @interface CurrentTimeVirtualAttributeResponseAllOf
 */
export interface CurrentTimeVirtualAttributeResponseAllOf {
    /**
     * A description for this Virtual Attribute
     * @type {string}
     * @memberof CurrentTimeVirtualAttributeResponseAllOf
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumcurrentTimeVirtualAttributeSchemaUrn>}
     * @memberof CurrentTimeVirtualAttributeResponseAllOf
     */
    'schemas'?: Array<EnumcurrentTimeVirtualAttributeSchemaUrn>;
    /**
