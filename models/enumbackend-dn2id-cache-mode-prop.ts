 ...
 * @enum {string}
 */
export type EnumbackendDn2idCacheModeProp = 'cache-keys-and-values' | 'cache-keys-only' | 'no-caching' | 'keep-hot' | 'default' | 'make-cold' | 'evict-leaf-immediately' | 'evict-bin-immediately'
