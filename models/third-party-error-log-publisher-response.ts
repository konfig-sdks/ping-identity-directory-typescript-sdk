...
/**
 * @type ThirdPartyErrorLogPublisherResponse
 * @export
 */
export type ThirdPartyErrorLogPublisherResponse = Meta & SyslogJsonAuditLogPublisherResponseAllOf & ThirdPartyErrorLogPublisherShared;
