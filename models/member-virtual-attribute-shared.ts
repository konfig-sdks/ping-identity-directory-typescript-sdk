 ...
 * 
 * @export
 * @interface MemberVirtualAttributeShared
 */
export interface MemberVirtualAttributeShared {
    /**
     * A description for this Virtual Attribute
     * @type {string}
     * @memberof MemberVirtualAttributeShared
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnummemberVirtualAttributeSchemaUrn>}
     * @memberof MemberVirtualAttributeShared
     */
    'schemas': Array<EnummemberVirtualAttributeSchemaUrn>;
    /**
     ...
     * @memberof MemberVirtualAttributeShared
     */
    'allowRetrievingMembership'?: boolean;
    /**
