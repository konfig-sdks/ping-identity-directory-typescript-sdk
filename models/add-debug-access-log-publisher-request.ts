...
/**
 * @type AddDebugAccessLogPublisherRequest
 * @export
 */
export type AddDebugAccessLogPublisherRequest = AddSyslogJsonAuditLogPublisherRequestAllOf & DebugAccessLogPublisherShared;
