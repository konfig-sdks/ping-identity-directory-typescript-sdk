 ...
 * 
 * @export
 * @interface MemberOfServerGroupVirtualAttributeResponseAllOf
 */
export interface MemberOfServerGroupVirtualAttributeResponseAllOf {
    /**
     * A description for this Virtual Attribute
     * @type {string}
     * @memberof MemberOfServerGroupVirtualAttributeResponseAllOf
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnummemberOfServerGroupVirtualAttributeSchemaUrn>}
     * @memberof MemberOfServerGroupVirtualAttributeResponseAllOf
     */
    'schemas'?: Array<EnummemberOfServerGroupVirtualAttributeSchemaUrn>;
    /**
