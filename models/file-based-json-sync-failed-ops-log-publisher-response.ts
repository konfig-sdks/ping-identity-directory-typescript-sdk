...
import { FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf } from './file-based-json-sync-failed-ops-log-publisher-response-all-of';
...
/**
 * @type FileBasedJsonSyncFailedOpsLogPublisherResponse
 * @export
 */
export type FileBasedJsonSyncFailedOpsLogPublisherResponse = FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf & Meta;
