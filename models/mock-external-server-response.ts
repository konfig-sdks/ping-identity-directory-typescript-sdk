...
import { MockExternalServerResponseAllOf } from './mock-external-server-response-all-of';

/**
 * @type MockExternalServerResponse
 * @export
 */
export type MockExternalServerResponse = Meta & MockExternalServerResponseAllOf;
