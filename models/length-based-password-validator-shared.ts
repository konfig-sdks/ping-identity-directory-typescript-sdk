 ...
 * 
 * @export
 * @interface LengthBasedPasswordValidatorShared
 */
export interface LengthBasedPasswordValidatorShared {
    /**
     * A description for this Password Validator
     * @type {string}
     * @memberof LengthBasedPasswordValidatorShared
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumlengthBasedPasswordValidatorSchemaUrn>}
     * @memberof LengthBasedPasswordValidatorShared
     */
    'schemas': Array<EnumlengthBasedPasswordValidatorSchemaUrn>;
    /**
