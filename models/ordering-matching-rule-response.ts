...
import { OrderingMatchingRuleResponseAllOf } from './ordering-matching-rule-response-all-of';

/**
 * @type OrderingMatchingRuleResponse
 * @export
 */
export type OrderingMatchingRuleResponse = Meta & OrderingMatchingRuleResponseAllOf;
