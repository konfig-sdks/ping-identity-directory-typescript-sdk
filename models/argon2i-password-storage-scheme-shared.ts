 ...
 * 
 * @export
 * @interface Argon2iPasswordStorageSchemeShared
 */
export interface Argon2iPasswordStorageSchemeShared {
    /**
     * A description for this Password Storage Scheme
     * @type {string}
     * @memberof Argon2iPasswordStorageSchemeShared
     */
    'description'?: string;
    /**
     * 
     * @type {Array<Enumargon2iPasswordStorageSchemeSchemaUrn>}
     * @memberof Argon2iPasswordStorageSchemeShared
     */
    'schemas': Array<Enumargon2iPasswordStorageSchemeSchemaUrn>;
    /**
