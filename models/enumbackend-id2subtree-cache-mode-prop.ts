 ...
 * @enum {string}
 */
export type EnumbackendId2subtreeCacheModeProp = 'cache-keys-and-values' | 'cache-keys-only' | 'no-caching' | 'keep-hot' | 'default' | 'make-cold' | 'evict-leaf-immediately' | 'evict-bin-immediately'
