...
import { SnmpSubAgentAlertHandlerShared } from './snmp-sub-agent-alert-handler-shared';

/**
 * @type SnmpSubAgentAlertHandlerResponse
 * @export
 */
export type SnmpSubAgentAlertHandlerResponse = Meta & SmtpAlertHandlerResponseAllOf & SnmpSubAgentAlertHandlerShared;
