 ...
 * 
 * @export
 * @interface SyslogJsonSyncLogPublisherResponseAllOf
 */
export interface SyslogJsonSyncLogPublisherResponseAllOf {
    /**
     * A description for this Log Publisher
     * @type {string}
     * @memberof SyslogJsonSyncLogPublisherResponseAllOf
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumsyslogJsonSyncLogPublisherSchemaUrn>}
     * @memberof SyslogJsonSyncLogPublisherResponseAllOf
     */
    'schemas'?: Array<EnumsyslogJsonSyncLogPublisherSchemaUrn>;
    /**
