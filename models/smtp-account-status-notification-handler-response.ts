...
/**
 * @type SmtpAccountStatusNotificationHandlerResponse
 * @export
 */
export type SmtpAccountStatusNotificationHandlerResponse = Meta & SmtpAccountStatusNotificationHandlerResponseAllOf & SmtpAccountStatusNotificationHandlerShared;
