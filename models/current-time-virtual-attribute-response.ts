...
import { CurrentTimeVirtualAttributeResponseAllOf } from './current-time-virtual-attribute-response-all-of';
...
/**
 * @type CurrentTimeVirtualAttributeResponse
 * @export
 */
export type CurrentTimeVirtualAttributeResponse = CurrentTimeVirtualAttributeResponseAllOf & Meta;
