...
import { EnumentryUuidVirtualAttributeSchemaUrn } from './enumentry-uuid-virtual-attribute-schema-urn';
 ...
 * 
 * @export
 * @interface EntryUuidVirtualAttributeResponseAllOf
 */
export interface EntryUuidVirtualAttributeResponseAllOf {
    /**
     * A description for this Virtual Attribute
     * @type {string}
     * @memberof EntryUuidVirtualAttributeResponseAllOf
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumentryUuidVirtualAttributeSchemaUrn>}
     * @memberof EntryUuidVirtualAttributeResponseAllOf
     */
    'schemas'?: Array<EnumentryUuidVirtualAttributeSchemaUrn>;
    /**
