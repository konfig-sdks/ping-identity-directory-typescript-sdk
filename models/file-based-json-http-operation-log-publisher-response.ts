...
/**
 * @type FileBasedJsonHttpOperationLogPublisherResponse
 * @export
 */
export type FileBasedJsonHttpOperationLogPublisherResponse = FileBasedJsonHttpOperationLogPublisherShared & Meta & SyslogJsonAuditLogPublisherResponseAllOf;
