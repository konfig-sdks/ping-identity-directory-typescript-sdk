 ...
 * 
 * @export
 * @interface ThirdPartyRecurringTaskShared
 */
export interface ThirdPartyRecurringTaskShared {
    /**
     * A description for this Recurring Task
     * @type {string}
     * @memberof ThirdPartyRecurringTaskShared
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumthirdPartyRecurringTaskSchemaUrn>}
     * @memberof ThirdPartyRecurringTaskShared
     */
    'schemas': Array<EnumthirdPartyRecurringTaskSchemaUrn>;
    /**
