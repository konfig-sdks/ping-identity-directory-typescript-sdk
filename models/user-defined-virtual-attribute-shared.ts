 ...
 * 
 * @export
 * @interface UserDefinedVirtualAttributeShared
 */
export interface UserDefinedVirtualAttributeShared {
    /**
     * A description for this Virtual Attribute
     * @type {string}
     * @memberof UserDefinedVirtualAttributeShared
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumuserDefinedVirtualAttributeSchemaUrn>}
     * @memberof UserDefinedVirtualAttributeShared
     */
    'schemas': Array<EnumuserDefinedVirtualAttributeSchemaUrn>;
    /**
