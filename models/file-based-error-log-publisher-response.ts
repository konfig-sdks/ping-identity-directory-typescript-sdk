...
/**
 * @type FileBasedErrorLogPublisherResponse
 * @export
 */
export type FileBasedErrorLogPublisherResponse = FileBasedErrorLogPublisherShared & Meta & SyslogJsonAuditLogPublisherResponseAllOf;
