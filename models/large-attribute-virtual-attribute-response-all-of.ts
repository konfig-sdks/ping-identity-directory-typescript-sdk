 ...
 * 
 * @export
 * @interface LargeAttributeVirtualAttributeResponseAllOf
 */
export interface LargeAttributeVirtualAttributeResponseAllOf {
    /**
     * A description for this Virtual Attribute
     * @type {string}
     * @memberof LargeAttributeVirtualAttributeResponseAllOf
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumlargeAttributeVirtualAttributeSchemaUrn>}
     * @memberof LargeAttributeVirtualAttributeResponseAllOf
     */
    'schemas'?: Array<EnumlargeAttributeVirtualAttributeSchemaUrn>;
    /**
