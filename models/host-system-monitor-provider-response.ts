...
import { HostSystemMonitorProviderResponseAllOf } from './host-system-monitor-provider-response-all-of';
...
/**
 * @type HostSystemMonitorProviderResponse
 * @export
 */
export type HostSystemMonitorProviderResponse = HostSystemMonitorProviderResponseAllOf & Meta;
