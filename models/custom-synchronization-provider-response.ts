...
import { CustomSynchronizationProviderResponseAllOf } from './custom-synchronization-provider-response-all-of';
...
/**
 * @type CustomSynchronizationProviderResponse
 * @export
 */
export type CustomSynchronizationProviderResponse = CustomSynchronizationProviderResponseAllOf & Meta;
