...
import { CustomAlertHandlerResponseAllOf } from './custom-alert-handler-response-all-of';
...
/**
 * @type CustomAlertHandlerResponse
 * @export
 */
export type CustomAlertHandlerResponse = CustomAlertHandlerResponseAllOf & Meta;
