...
/**
 * @type GetPlugin200Response
 * @export
 */
export type GetPlugin200Response = AttributeMapperPluginResponse | ChangeSubscriptionNotificationPluginResponse | ChangelogPasswordEncryptionPluginResponse | CleanUpExpiredPingfederatePersistentAccessGrantsPluginResponse | CleanUpExpiredPingfederatePersistentSessionsPluginResponse | CleanUpInactivePingfederatePersistentSessionsPluginResponse | CoalesceModificationsPluginResponse | ComposedAttributePluginResponse | CustomPluginResponse | DelayPluginResponse | DnMapperPluginResponse | EncryptAttributeValuesPluginResponse | GroovyScriptedPluginResponse | InternalSearchRatePluginResponse | InvertedStaticGroupReferentialIntegrityPluginResponse | LastAccessTimePluginResponse | LastModPluginResponse | LdapResultCodeTrackerPluginResponse | ModifiablePasswordPolicyStatePluginResponse | MonitorHistoryPluginResponse | PassThroughAuthenticationPluginResponse | PasswordPolicyImportPluginResponse | PeriodicGcPluginResponse | PeriodicStatsLoggerPluginResponse | PingOnePassThroughAuthenticationPluginResponse | PluggablePassThroughAuthenticationPluginResponse | ProcessingTimeHistogramPluginResponse | ProfilerPluginResponse | PurgeExpiredDataPluginResponse | ReferentialIntegrityPluginResponse | ReferralOnUpdatePluginResponse | SearchShutdownPluginResponse | SevenBitCleanPluginResponse | SimpleToExternalBindPluginResponse | SnmpSubagentPluginResponse | StatsCollectorPluginResponse | SubOperationTimingPluginResponse | ThirdPartyPluginResponse | TraditionalStaticGroupSupportForInvertedStaticGroupsPluginResponse | UniqueAttributePluginResponse;
