...
import { LargeAttributeBackendResponseAllOf } from './large-attribute-backend-response-all-of';
...
/**
 * @type LargeAttributeBackendResponse
 * @export
 */
export type LargeAttributeBackendResponse = LargeAttributeBackendResponseAllOf & Meta;
