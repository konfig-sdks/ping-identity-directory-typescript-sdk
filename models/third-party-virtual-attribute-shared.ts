 ...
 * 
 * @export
 * @interface ThirdPartyVirtualAttributeShared
 */
export interface ThirdPartyVirtualAttributeShared {
    /**
     * A description for this Virtual Attribute
     * @type {string}
     * @memberof ThirdPartyVirtualAttributeShared
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumthirdPartyVirtualAttributeSchemaUrn>}
     * @memberof ThirdPartyVirtualAttributeShared
     */
    'schemas': Array<EnumthirdPartyVirtualAttributeSchemaUrn>;
    /**
