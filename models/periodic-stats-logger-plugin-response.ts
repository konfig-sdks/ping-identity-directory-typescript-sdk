...
/**
 * @type PeriodicStatsLoggerPluginResponse
 * @export
 */
export type PeriodicStatsLoggerPluginResponse = Meta & PeriodicStatsLoggerPluginShared & TraditionalStaticGroupSupportForInvertedStaticGroupsPluginResponseAllOf;
