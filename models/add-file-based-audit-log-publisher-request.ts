...
/**
 * @type AddFileBasedAuditLogPublisherRequest
 * @export
 */
export type AddFileBasedAuditLogPublisherRequest = AddSyslogJsonAuditLogPublisherRequestAllOf & FileBasedAuditLogPublisherShared;
