...
import { FileBasedErrorLogPublisherShared } from './file-based-error-log-publisher-shared';

/**
 * @type AddFileBasedErrorLogPublisherRequest
 * @export
 */
export type AddFileBasedErrorLogPublisherRequest = AddSyslogJsonAuditLogPublisherRequestAllOf & FileBasedErrorLogPublisherShared;
