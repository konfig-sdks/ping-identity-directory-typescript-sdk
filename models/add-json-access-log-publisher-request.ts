...
/**
 * @type AddJsonAccessLogPublisherRequest
 * @export
 */
export type AddJsonAccessLogPublisherRequest = AddSyslogJsonAuditLogPublisherRequestAllOf & JsonAccessLogPublisherShared;
