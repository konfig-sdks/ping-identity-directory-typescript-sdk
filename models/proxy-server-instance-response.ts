...
import { ProxyServerInstanceResponseAllOf } from './proxy-server-instance-response-all-of';

/**
 * @type ProxyServerInstanceResponse
 * @export
 */
export type ProxyServerInstanceResponse = Meta & ProxyServerInstanceResponseAllOf;
