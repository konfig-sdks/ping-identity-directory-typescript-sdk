 ...
 * 
 * @export
 * @interface InstanceNameVirtualAttributeResponseAllOf
 */
export interface InstanceNameVirtualAttributeResponseAllOf {
    /**
     * A description for this Virtual Attribute
     * @type {string}
     * @memberof InstanceNameVirtualAttributeResponseAllOf
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnuminstanceNameVirtualAttributeSchemaUrn>}
     * @memberof InstanceNameVirtualAttributeResponseAllOf
     */
    'schemas'?: Array<EnuminstanceNameVirtualAttributeSchemaUrn>;
    /**
