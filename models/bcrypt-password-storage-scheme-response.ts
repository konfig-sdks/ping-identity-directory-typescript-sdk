...
/**
 * @type BcryptPasswordStorageSchemeResponse
 * @export
 */
export type BcryptPasswordStorageSchemeResponse = Argon2dPasswordStorageSchemeResponseAllOf & BcryptPasswordStorageSchemeShared & Meta;
