...
/**
 * @type GroovyScriptedHttpOperationLogPublisherResponse
 * @export
 */
export type GroovyScriptedHttpOperationLogPublisherResponse = GroovyScriptedHttpOperationLogPublisherShared & Meta & SyslogJsonAuditLogPublisherResponseAllOf;
