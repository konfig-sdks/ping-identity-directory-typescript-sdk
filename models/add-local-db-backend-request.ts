...
import { AddLocalDbBackendRequestAllOf } from './add-local-db-backend-request-all-of';
...
import { LocalDbBackendShared } from './local-db-backend-shared';

/**
 * @type AddLocalDbBackendRequest
 * @export
 */
export type AddLocalDbBackendRequest = AddLocalDbBackendRequestAllOf & LocalDbBackendShared;
