...
/**
 * @type OperationTimingAccessLogPublisherResponse
 * @export
 */
export type OperationTimingAccessLogPublisherResponse = Meta & OperationTimingAccessLogPublisherShared & SyslogJsonAuditLogPublisherResponseAllOf;
