 ...
 * 
 * @export
 * @interface ErrorLogAlertHandlerShared
 */
export interface ErrorLogAlertHandlerShared {
    /**
     * A description for this Alert Handler
     * @type {string}
     * @memberof ErrorLogAlertHandlerShared
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumerrorLogAlertHandlerSchemaUrn>}
     * @memberof ErrorLogAlertHandlerShared
     */
    'schemas': Array<EnumerrorLogAlertHandlerSchemaUrn>;
    /**
