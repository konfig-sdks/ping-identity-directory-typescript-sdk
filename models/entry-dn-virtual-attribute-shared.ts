 ...
 * 
 * @export
 * @interface EntryDnVirtualAttributeShared
 */
export interface EntryDnVirtualAttributeShared {
    /**
     * A description for this Virtual Attribute
     * @type {string}
     * @memberof EntryDnVirtualAttributeShared
     */
    'description'?: string;
    /**
     * 
     * @type {Array<EnumentryDnVirtualAttributeSchemaUrn>}
     * @memberof EntryDnVirtualAttributeShared
     */
    'schemas': Array<EnumentryDnVirtualAttributeSchemaUrn>;
    /**
