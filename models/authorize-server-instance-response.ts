...
import { AuthorizeServerInstanceResponseAllOf } from './authorize-server-instance-response-all-of';
...
/**
 * @type AuthorizeServerInstanceResponse
 * @export
 */
export type AuthorizeServerInstanceResponse = AuthorizeServerInstanceResponseAllOf & Meta;
