...
/**
 * @type AddGroovyScriptedAlertHandlerRequest
 * @export
 */
export type AddGroovyScriptedAlertHandlerRequest = AddSmtpAlertHandlerRequestAllOf & GroovyScriptedAlertHandlerShared;
