...
/**
 * @type JdbcBasedErrorLogPublisherResponse
 * @export
 */
export type JdbcBasedErrorLogPublisherResponse = JdbcBasedErrorLogPublisherShared & Meta & SyslogJsonAuditLogPublisherResponseAllOf;
