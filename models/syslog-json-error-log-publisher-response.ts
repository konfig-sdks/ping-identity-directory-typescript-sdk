...
/**
 * @type SyslogJsonErrorLogPublisherResponse
 * @export
 */
export type SyslogJsonErrorLogPublisherResponse = Meta & SyslogJsonAuditLogPublisherResponseAllOf & SyslogJsonErrorLogPublisherShared;
