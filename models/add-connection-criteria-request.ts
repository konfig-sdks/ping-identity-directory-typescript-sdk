...
import { AddAggregateConnectionCriteriaRequest } from './add-aggregate-connection-criteria-request';
import { AddSimpleConnectionCriteriaRequest } from './add-simple-connection-criteria-request';
import { AddThirdPartyConnectionCriteriaRequest } from './add-third-party-connection-criteria-request';
...
/**
 * @type AddConnectionCriteriaRequest
 * @export
 */
export type AddConnectionCriteriaRequest = AddAggregateConnectionCriteriaRequest | AddSimpleConnectionCriteriaRequest | AddThirdPartyConnectionCriteriaRequest;
