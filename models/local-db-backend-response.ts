...
import { LocalDbBackendResponseAllOf } from './local-db-backend-response-all-of';
...
/**
 * @type LocalDbBackendResponse
 * @export
 */
export type LocalDbBackendResponse = LocalDbBackendResponseAllOf & LocalDbBackendShared & Meta;
