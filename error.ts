...
/**
 * This class provides a wrapper for network errors when making requests to PingData Config - OpenAPI 3.0
 */
export class PingIdentityDirectoryError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "PingIdentityDirectoryError";
